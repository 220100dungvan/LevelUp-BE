import z from 'zod'
import { TypeOfVerificationCode, UserRole, UserStatus } from '../../common/constants/auth.constant'
...
export const RegisterBodySchema = z
  .object({
    ...
    role: z.enum([UserRole.LEARNER, UserRole.TEACHER]).optional(),
...
export const VerifyTwoFactorSetupBodySchema = z
  .object({
    secret: z.string(),
...
export type VerifyTwoFactorSetupBodyType = z.infer<typeof VerifyTwoFactorSetupBodySchema>
